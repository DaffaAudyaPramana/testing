            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <div class="mt-4">
                            <a href="mailto:{{$viewData->email}}"><button type="button" class="btn btn-primary btn-sm"><i class="uil uil-envelope-alt me-2"></i>
                                ...
                                <div id="password-settings" class="tab-pane fade">
                                    <div class="pt-3">
                                        <div class="settings-form">
                                            ...
                                            <form action="{{route('edit-pw-user')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
